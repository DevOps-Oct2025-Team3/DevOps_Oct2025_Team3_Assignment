...
function verifyJWT(req, res, next) {
    ...
    jwt.verify(token, process.env.JWT_SECRET, (err, decoded) => {  
        ...
        const authorizedRoles = {
          ...
          // Admin-only user management (if present)
          "GET /admin": ["Admin"],             
          ...
          // File service dashboard endpoints - both Admin and User can access their files
          "GET /dashboard": ["Admin", "User"],
          "POST /dashboard/upload": ["Admin", "User"],
          // Mongo-style object IDs (24 hex chars) for delete/download
          "DELETE /dashboard/delete/[0-9a-fA-F]{24}": ["Admin", "User"],
          "GET /dashboard/download/[0-9a-fA-F]{24}": ["Admin", "User"],
        };
